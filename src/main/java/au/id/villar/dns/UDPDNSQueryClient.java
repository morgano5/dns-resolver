...
class UDPDNSQueryClient /*implements DNSQueryClient*/ {
...
//
//	UDPDNSQueryClient(DnsEngine engine) {
//		this.engine = engine;
//	}
//
//	public boolean startQuery(ByteBuffer question, String address, int timeoutMillis) {
//		closeResources();
